...
private const val OPTION_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Option Screen"
private const val LANGUAGE_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Language Screen"
private const val ADD_EXCHANGE_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Add Exchange Screen"
private const val RECORD_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Record Screen"
private const val ABOUT_EXCHANGE_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to About Exchange Screen"
private const val EDIT_EXCHANGE_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Edit Exchange Screen"
private const val REPORT_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Report Screen"
private const val ABOUT_MONTH_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to About Month Screen"
private const val MAIN_SCREEN_NAVIGATION_MESSAGE = "[AppNavigation][ACTION] Navigate to Main Screen"
private const val SIGN_UP_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Sign Up Screen"
private const val LOG_IN_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Log In Screen"
private const val RECOVERY_PASS_SCREEN_NAVIGATION_MESSAGE =
    "[AppNavigation][ACTION] Navigate to Log In Screen"
